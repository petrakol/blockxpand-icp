...
- Includes built-in adapters for ICPSwap, Sonic, InfinitySwap and a generic SNS
  airdrop adapter. Additional DEXes can be added via `config/ledgers.toml` and
...
- `SNS_DISTRIBUTOR` – optional SNS airdrop canister ID
